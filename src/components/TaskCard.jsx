                ...
                <div className="px-4 pl-5 pb-3 space-y-0.5">
                    <div className="border-t border-white/5 pt-2 space-y-0.5">
                        {task.checklist.map(item => (
                            ...
                            >
                                <div className={`flex-shrink-0 transition-all duration-300 ${item.isCompleted ? 'text-acid' : 'text-white/20'}`}>
                                    {item.isCompleted ? <CheckCircle2 size={14} /> : <Circle size={14} />}
                                </div>
                                <span className={`text-[11px] flex-1 transition-all duration-300 leading-tight ${item.isCompleted ? 'line-through text-white/25' : 'text-white/60'}`}>
                                    {item.text}
                                </span>
                            </div>
                        ))}
