            ...
            <div className="grid gap-6">
                ...
                <div className="glass-card p-6">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-white">Color de acento</h3>
                            <p className="text-sm text-text-muted">Personaliza el color principal de la interfaz desde tu perfil.</p>
                        </div>
                    </div>
                    <ColorPicker
