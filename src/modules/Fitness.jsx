...
const INITIAL_HABITS = [
    {
        ...
        name: 'Creatina',
        color: '#3b82f6',
        frequency: 1, // 1: Todos, 2: Entre semana, 3: Fines de semana
        history: { '2026-02-01': 1, '2026-02-03': 1, '2026-02-05': 1, '2026-02-06': 1 },
        streak: 4
    },
    {
        id: 2,
        ...
        color: '#22c55e',
        frequency: 2,
        history: { '2026-02-02': 1, '2026-02-04': 1, '2026-02-05': 1, '2026-02-06': 1 },
        streak: 4
    },
    {
        id: 3,
        ...
        color: '#f97316',
        frequency: 3,
        history: { '2026-02-01': 1, '2026-02-07': 1 },
        streak: 2
    },
];
...
export default function Fitness() {
    ...
    const toggleHabit = (habitId, dateStr, dayObj, freq) => {
        ...
        if (!isDayApplicable(dayObj, freq)) return; // Don't allow toggling blocked days
    ...
    const removeHabit = (id) => {
        if (habits.length <= 1) {
            alert("No puedes eliminar todos los hábitos.");
            return;
        }
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                ...
                <div className="glass-card glass-card-hover-green p-6 flex items-center justify-between border border-white/5 bg-[#050505]/40 backdrop-blur-xl transition-colors relative overflow-hidden group">
                    ...
                    <div className="relative z-10 min-w-0 flex-1 pr-4">
                        ...
                        <div className="flex items-baseline gap-2 w-full mt-[6px]">
                            <span className="text-[32px] font-bold text-acid tracking-tighter leading-none shrink-0">{getCompletionRate(bestHabit)}%</span>
                ...
                <div className="glass-card glass-card-hover-red p-6 flex items-center justify-between border border-white/5 bg-[#050505]/40 backdrop-blur-xl transition-colors relative overflow-hidden group">
                    ...
                    <div className="relative z-10 min-w-0 flex-1 pr-4">
                        ...
                        <div className="flex items-baseline gap-2 w-full mt-[6px]">
                            <span className="text-[32px] font-bold text-red-500 tracking-tighter leading-none shrink-0">{getCompletionRate(worstHabit)}%</span>
                                                ...
                                                <>
                                                    ...
                                                    <button
                                                        onClick={() => {
                                                            ...
                                                            updateHabit(habit.id, 'frequency', nextFreq);
                                                        }}
